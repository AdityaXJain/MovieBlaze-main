      ...
      <div className="max-w-7xl mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div>
            ...
            <p className="text-sm">Discover your next favorite movie with MovieBlaze. We provide the latest information on movies, trailers, and where to watch them.</p>
          </div>
          <div>
        ...
        <div className="mt-8 border-t border-gray-700 pt-4 text-center">
          <p className="text-sm">&copy; 2023 MovieBlaze. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
